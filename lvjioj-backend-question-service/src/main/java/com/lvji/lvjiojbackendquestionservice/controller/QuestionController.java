package com.lvji.lvjiojbackendquestionservice.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;

import com.lvji.lvjiojbackendcommon.annotation.AuthCheck;
import com.lvji.lvjiojbackendcommon.common.BaseResponse;
import com.lvji.lvjiojbackendcommon.common.DeleteRequest;
import com.lvji.lvjiojbackendcommon.common.ErrorCode;
import com.lvji.lvjiojbackendcommon.common.ResultUtils;
import com.lvji.lvjiojbackendcommon.constant.UserConstant;
import com.lvji.lvjiojbackendcommon.exception.BusinessException;
import com.lvji.lvjiojbackendcommon.exception.ThrowUtils;
import com.lvji.lvjiojbackendmodel.dto.question.*;
...
import com.lvji.lvjiojbackendmodel.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        // 非管理员、非本人不可查看题目的全部信息
        User loginUser = userFeignClient.getLoginUser(request);
        if (question.getUserId() != loginUser.getId() && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
